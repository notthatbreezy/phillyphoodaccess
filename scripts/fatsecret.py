...
class Fatsecret:
    ...
    def recipe_search(self,search_expression,page_number=None,max_results=None):
        params={'method': 'recipe.search','oauth_token': self.access_token,'search_expression':search_expression,'format':'json'} 
        if page_number!=None:
            params['page_number'] = page_number
        if max_results!=None:
            params['max_results'] = max_results
